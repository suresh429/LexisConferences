...
public class CatpaymentAdapter$SingleViewHolder_ViewBinding implements Unbinder {
  private CatpaymentAdapter.SingleViewHolder target;

  @UiThread
  public CatpaymentAdapter$SingleViewHolder_ViewBinding(CatpaymentAdapter.SingleViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CatpaymentAdapter.SingleViewHolder target = this.target;
