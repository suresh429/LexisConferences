...
public class YRFAdapter$SingleViewHolder_ViewBinding implements Unbinder {
  private YRFAdapter.SingleViewHolder target;

  @UiThread
  public YRFAdapter$SingleViewHolder_ViewBinding(YRFAdapter.SingleViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    YRFAdapter.SingleViewHolder target = this.target;
